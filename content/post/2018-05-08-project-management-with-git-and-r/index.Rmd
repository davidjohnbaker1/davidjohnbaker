...
![Navigate to New Repository Page](pmwr1.png){width=100%}
...
![Setting up your repo](pmwr2.png){width=100%}
...
![The Blank Page](pmwr3.png){width=100%}
...
![Clone the Git HTTPS](pmwr4.png){width=100%}
...
![Cloning Your Repo](/img/project-management-with-git/pmwr5.png){width=100%}
