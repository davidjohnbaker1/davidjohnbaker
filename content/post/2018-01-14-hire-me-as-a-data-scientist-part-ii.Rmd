...
I could use this new table I've made to index through our dataset of all the reviews that I had (that have their ABV ratings!) so I was then only dealing with these higher quality reviewers.
...
The dataset ‘as is’ comes with a ```beer_id``` unique ID, but the data downloaded as is does not give us a key to this, so I had to make it ourselves. 
...
Again I see this is clearly **not** anything resembling a repeated measures experiment and not all beers were rated equally. 
...
But what if I was trying to sketch out some ideas about what other beers that I could recommend to beer lovers who like Pliny The Elder, it needed to somewhat “look like” the target beer, but have way less reviews.
