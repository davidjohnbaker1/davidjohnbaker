...
![](/img/melosol/Figure_1.png)

> FIGURE 2 

![](/img/melosol/Figure_2.png)
...
![](/img/melosol/Figure_3.png)

The third figure plots another aspect that might not be of immediate interest to non-music-psychology readers which is the contour or shape of a melody.
...
Figure 4 was an attempt to start to answer the question how similar these two corpora are.

> FIGURE 4

![](/img/melosol/Figure_5.png)
...
The analysis in Figure 4 does this on the musical intervals that are present in the corpora.
...
So what Figure 4 shows you is basically that thought experiment run on both of the corpora.
...
That's what Figure 5 tries to quantify.

> FIGURE 5

![](/img/melosol/Figure_6.png)
