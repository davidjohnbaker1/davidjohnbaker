...
One of the major problems I face in my work was a problem that in order to make robust claims about music, you need to be able to show similar phenomena happen with new data.
...
But in cases like the one I'm describing here, we have our own weird, little problem. 

To remedy this, I imagine a world where in teaching music theory-- where often competence in a computer notation is a learning objective-- we spend a bit of time talking about this problem of (digital) representation in music.
If every small, little classroom were encodes some pop melodies (also a transcription exercise!), encode a Shostakovitch Fugue (a project I have been putting off for years now), or even does one part of a symphony, all of this data would slowly start to accumulate for anyone to model.
This would lead to a deluge of new data for researchers to use, allow for Meyerian comparisons between styles, and teach students about serious pressing problems in research while having them learn about notational software.
Also once compositions cross into the public domain, we as a research community can work towards having more more music, more accessible to more people in the form of open scores.
