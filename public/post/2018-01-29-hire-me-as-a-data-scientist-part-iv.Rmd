...
the question well.
Let's first just average over all the beer styles to get a rough estimate of how a beer style fairs
...
Now knowing how each beer style varies on our variables of interest (with our overall score
...
By doing this we can have a bit more confidence in what we are looking at that it actually has
some meaning.
...
Looking at this subsection, it appears that we have a few choices for beers that score highly on
...
take off our data science hats and put our psychology ones back (assuming that's what we were wearing...) on and run some double-blind experiments on ourselves just to make sure that our data is actually lining up with something in
the real world.

## Reflections

What started out as a fun weekend project actually turned into a really great learning
experience.
I've definitely put a few solid hours into this and have gotten a lot out of it.
I learned that my friends actually know a TON about beer and data science, that [git-lfs](https://git-lfs.github.com/) is a thing that something I wish I would have known about earlier,
...
summer will come across these posts and think that I might be a good temporary addition to
their team.