...
![Overall Skew](/img/examining-gmsi/Figure1_GMSIREP.png){width=100%}

![Similar Descriptive Statistics](/img/examining-gmsi/Figure2_GMSIREP.png){width=100%}

That said, we did look at the item level data and found anything but normal distributions.

![Item Level Distributions](/img/examining-gmsi/Figure3_GMSIREP.png){width=100%}
