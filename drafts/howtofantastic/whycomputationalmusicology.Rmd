...
When I have to give the academic version of my two minute elevator speech describing what I "do", often I  say most of it falls into either **computational musicology** or **music psychology**.
...
Relatively speaking, I don't think the world has enough [computational musicology](https://pushpullfork.com/computational-musicology/) as reflected in its very sad [wikipedia page](https://en.wikipedia.org/wiki/Computational_musicology).
...
The **first reason** is totally self-motivated and relates to my last point of my second reason: It'd be nice to have more friends working in computational musicology and I think raising awareness and increasing accesibility is a great way to grow the community.
I'm also pretty keen on the whole public musicology thing and think if a small percentage of Louisianan's tax dollars end up going to pay my paycheck to let me have probably one of the most obsure jobs ever imaginable ("Music Theorist"), what I work on should be availble in a bite-size version that doesn't require a PhD to do understand. 
...
For the most part computers are pretty user friendly.
The thing is, most people pretty much use their computer as a $1,000 Facebook-Email-Netfilix-Reddit-Word-Proccessor-Powerpoint-Maker machine and then add to that expense by buying a bunch of very expensive software.
While there is nothing wrong with that, computers today are magnitutes more powerful than they were compared a few decades ago and today you can actually train a neural network on the same computer you use to watch cat gifs.
The tools from computational musicology rely on freely availbible software and you'll have to learn a lot about your computer and all the wonderful things it can do by using it.

## Computational Thinking

Once you learn a bit more about how your computer actually works, the next thing on the list is to come up with an interestign question to ask. Next on list?
Of course asking a good question isn't exclusive to computational musicology, but in order to actually "ask" the computer your question, it needs to very well-formed. 
